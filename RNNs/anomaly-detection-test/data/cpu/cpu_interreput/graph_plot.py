...
file_name = "CpuPerc.cpu.interrupt.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'cpu_perc_interrupt']
...
for i in range(1,141000):
    ...
    y.append(float(row['cpu_perc_interrupt']))
...
print 'Some stats on CPU- Interrupt data from last 180 days'
...
plt.ylabel('CPU-Perc-Interrupt')
plt.plot(y)
plt.grid(True)
plt.savefig('cpu_perc_interrupt.png')
