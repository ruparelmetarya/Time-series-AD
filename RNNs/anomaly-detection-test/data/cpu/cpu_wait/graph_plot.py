...
file_name = "CpuPerc.cpu.wait.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'cpu_perc_wait']
...
for i in range(1,141000):
    ...
    y.append(float(row['cpu_perc_wait']))
...
# median = median(y)
#
# print 'Some stats on CPU-wait data from last 180 days'
...
plt.plot(y)
plt.grid(True)
plt.savefig('cpu_perc_idle_only.png')
