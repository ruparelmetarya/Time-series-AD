...
file_name = "CpuPerc.cpu.softirq.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'cpu_perc_softirq']
...
for i in range(1,141000):
    ...
    y.append(float(row['cpu_perc_softirq']))
...
# median = median(y)
#
# print 'Some stats on CPU-Perc-Softirq data from last 180 days'
...
plt.ylabel('CPU-Perc-Softirq')
plt.plot(y)
plt.grid(True)
plt.savefig('cpu_perc_softirq.png')
