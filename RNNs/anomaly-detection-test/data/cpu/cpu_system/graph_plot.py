...
COLUMNS = ["timestamp", "cpu-perc_system"]
file_name = "CpuPerc.cpu.system.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'cpu_perc_system']
...
for i in range(1,141000):
    ...
    y.append(float(row['cpu_perc_system']))
...
print 'Some stats on CPU-system data from last 180 days'
...
# plt.ylabel('CPU-Perc-System')
# plt.plot(y)
# plt.grid(True)
# plt.savefig('cpu_perc_system.png')
