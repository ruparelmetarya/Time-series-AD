...
COLUMNS = ["timestamp", "cpu-nice"]
file_name = "CpuPerc.cpu.nice.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'cpu_perc_nice']
...
for i in range(1,141000):
    ...
    y.append(float(row['cpu_perc_nice']))
...
# median = median(y)
#
# print 'Some stats on CPU-nice data from last 180 days'
...
plt.ylabel('CPU-Perc-Nice')
plt.plot(y)
plt.grid(True)
plt.savefig('cpu_perc_nice.png')
