...
file_name = "load.load.longterm.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'load_longterm']
...
for i in range(1,141000):
    ...
    y.append(float(row['load_longterm']))
...
# print 'Some stats on longterm load data from last 180 days'
...
plt.ylabel('Longterm Load')
plt.plot(y)
plt.grid(True)
plt.savefig('longterm_load.png')
