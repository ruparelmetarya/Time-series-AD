...
COLUMNS = ["timestamp", "mid_term_load"]
file_name = "load.load.midterm.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'load_midterm']
...
for i in range(1,141000):
    ...
    y.append(float(row['load_midterm']))
...
# median = median(y)
#
# print 'Some stats on midterm load data from last 180 days'
...
plt.ylabel('midterm Load')
plt.plot(y)
plt.grid(True)
plt.savefig('midterm_load.png')
