...
file_name = "CpuPerc.cpu.user.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'cpu_perc_user']
...
for i in range(1,141000):
    ...
    y.append(float(row['cpu_perc_user']))
...
# median = median(y)
#
# print 'Some stats on CPU-user data from last 180 days'
...
plt.ylabel('CPU-Perc-USER')
plt.plot(y)
plt.grid(True)
plt.savefig('cpu_perc_USER.png')
