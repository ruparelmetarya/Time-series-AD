...
COLUMNS = ["timestamp", "power_supply_2"]
file_name = "powerstats.gauge.PowerSupply2.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'power_supply_2']
...
for i in range(1,141000):
    ...
    y.append(float(row['power_supply_2']))
...
# median = median(y)
#
# print 'Some stats on Power Supply (2) data from last 180 days'
...
plt.ylabel('Power_Supply_2')
plt.plot(y)
plt.grid(True)
plt.savefig('power_supply_2.png')
