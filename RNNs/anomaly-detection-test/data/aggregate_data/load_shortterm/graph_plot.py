...
COLUMNS = ["timestamp", "load_shortterm"]
file_name = "load.load.shortterm.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'short_term_load']
...
for i in range(1,141000):
    ...
    y.append(float(row['short_term_load']))
...
# print 'Some stats on shortterm load data from last 180 days'
...
plt.ylabel('Short Term Load')
plt.plot(y)
plt.grid(True)
plt.savefig('short_term_load.png')
