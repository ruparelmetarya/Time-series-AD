...
COLUMNS = ["timestamp", "memory_buffered"]
file_name = "memory.memory.buffered.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'memory_buffered']
...
for i in range(1,140000):
    ...
    y.append(float(row['memory_buffered']))
...
plt.ylabel('Memory_Buffered')
plt.plot(y)
plt.grid(True)
plt.savefig('plots/memory_buffered.png')
