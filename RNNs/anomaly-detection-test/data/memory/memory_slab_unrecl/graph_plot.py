...
COLUMNS = ["timestamp", "memory_slab_unrecl"]
file_name = "memory.memory.slab_unrecl.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'memory_slab_unrecl']
...
for i in range(1,140000):
    ...
    y.append(float(row['memory_slab_unrecl']))
...
# plt.ylabel('Memory_Slab_Unrecl')
# plt.plot(y)
# plt.grid(True)
# plt.savefig('memory_slab_unrecl.png')
