...
COLUMNS = ["timestamp", "Memory_slab_recl"]
file_name = "memory.memory.slab_recl.csv"
...
with open(file_name, 'rb') as csvfile:
    field_names = ['time_stamp', 'memory_slab_recl']
...
for i in range(1,140000):
    ...
    y.append(float(row['memory_slab_recl']))
...
# plt.ylabel('Memory_Slab_Recl')
# plt.plot(y)
# plt.grid(True)
# plt.savefig('memory_slab_recl.png')
